...
// Repository instances — assigned in beforeEach. The definite-assignment
// assertion is required because TS cannot track assignments made inside a hook.
let catalogA!: CatalogRepo;
let catalogB!: CatalogRepo;
